    ...
    for (let i = 0; i < module.customCss.length; i++) {
      ...
      if (prop === element.prop) {
        ...
        return {
          ...
          top: element.css?.top != null ? `${element.css.top}px` : '',
          right: element.css?.right != null ? `${element.css.right}px` : '',
          bottom: element.css?.bottom != null ? `${element.css.bottom}px` : '',
          left: element.css?.left != null ? `${element.css.left}px` : '',
