<template>
  <div>
    <div
      v-for="(item, index) in module.dataSource[keyValue].value"
      :key="index"
      class="edu-background-data-box"
    >
      ...
      <div class="module-list-content-box">
        <!-- 数据填写组件 -->
        <div v-for="(value, key, dataIndex) in item" :key="dataIndex" :style="getFiledStyle(value)">
          <component
          ...
          >
            ...
            <template #label-right>
              <div class="field-label-right-box">
                <el-switch v-model="module.props[key].show" />
              </div>
            </template>
          </component>
        </div>
