...
<style lang="scss" scoped>
  .text-1-box {
    ...
    border-top-width: v-bind('props.widgetData?.css.borderWidthProps.top + "px"');
    border-right-width: v-bind('props.widgetData?.css.borderWidthProps.right + "px"');
    border-bottom-width: v-bind('props.widgetData?.css.borderWidthProps.bottom + "px"');
    border-left-width: v-bind('props.widgetData?.css.borderWidthProps.left + "px"');
