...
<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="风格名称:" prop="category_label">
...
<script lang="ts" setup>
  import { templateStyleAddAsync, templateStyleUpdateAsync } from '@/http/api/createTemplate';
    ...
    await formEl.validate(async (valid, fields) => {
      if (valid) {
        ...
        if (props.btnText === '添加') {
          ...
          const data = await templateStyleAddAsync(params);
          ...
          const data = await templateStyleUpdateAsync(params);
          if (data.data.status === 200) {
