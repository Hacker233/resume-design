...
<script lang="ts" setup>
  import { pptCategoryAddAsync, pptCategoryUpdateAsync } from '@/http/api/pptTemplate';
    ...
    await formEl.validate(async (valid, fields) => {
      if (valid) {
        ...
        if (props.btnText === '添加') {
          ...
          const data = await pptCategoryAddAsync(params);
          ...
          const data = await pptCategoryUpdateAsync(params);
          if (data.data.status === 200) {
