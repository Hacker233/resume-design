...
export const pricePlans: PricePlan[] = [
  {
    ...
    buttonColor: '#ecf1f9',
    features: [
      { text: '可获得简币数量', included: false, desc: '0枚' },
  ...
  },
  {
    ...
    buttonColor: '#6ed6bd',
    features: [
      { text: '可获得简币数量', included: true, desc: '990枚' },
      { text: '猫步简历官方微信交流群', included: true, desc: '' },
      { text: '前端最新源码', included: true, desc: '' },
      { text: '个人用户可用于商业应用开发', included: true, desc: '' },
    ...
    bottomDesc: '具备基础后台功能，无积分、积木创作等新功能'
  },
  {
    title: '升级版',
    price: 399,
    ...
    buttonColor: '#9a95eb',
    features: [
      { text: '可获得简币数量', included: true, desc: '3990枚' },
      { text: '猫步简历官方微信交流群', included: true, desc: '' },
      { text: '前端最新源码', included: true, desc: '' },
      { text: '个人用户可用于商业应用开发', included: true, desc: '' },
      { text: '网站开发部署文档', included: true, desc: '' },
    ...
    bottomText: '后端源码更新至2023年2月',
    bottomDesc: '具备完善的后台功能，如积分、积木创作等等'
  },
  {
    title: '永久更新版',
    price: 699,
    ...
    buttonColor: '#bd9772',
    features: [
      { text: '可获得简币数量', included: true, desc: '6990枚' },
      { text: '猫步简历官方微信交流群', included: true, desc: '' },
      { text: '前端最新源码', included: true, desc: '' },
      { text: '个人用户可用于商业应用开发', included: true, desc: '' },
      { text: '网站开发部署文档', included: true, desc: '' },
